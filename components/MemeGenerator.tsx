...
function MemeGenerator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-200 text-foreground ">
      <div className="max-w-4xl w-full px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center space-y-8">
          ...
          {loading ? (
            ...
            <>
              <div className="w-full overflow-x-scroll whitespace-nowrap py-2 overflow-y-hidden ">
